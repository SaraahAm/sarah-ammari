...
<!-- On affiche le hero -->
    <section class="hero">
        <h1> 
            <div class="h1-animation">BIENVENUE</div>
            <div class="h1-animation">
                <span>SUR MON PORTFOLIO</span>
            </div>
        </h1>
...
<!-- On affiche la présentation -->
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#F4976C" fill-opacity="1" d="M0,32L60,37.3C120,43,240,53,360,53.3C480,53,600,43,720,64C840,85,960,139,1080,133.3C1200,128,1320,64,1380,32L1440,0L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
